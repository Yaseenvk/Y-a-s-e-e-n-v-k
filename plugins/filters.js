...
Asena.addCommand({on: 'text', fromMe: false}, (async (message, match) => {
        ...
        let banned = jid.find( Jid => Jid === message.jid);
        if(banned !== undefined) return
        if (!!message.mention && message.mention[0] == '916282265881@s.whatsapp.net') {
await message.client.sendMessage(message.jid, fs.readFileSync('./Yaseen/Mention.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted : message.data, ptt: true})
        }
const array = ['Akhil','alive','Aliya','Aliyo','alone','Althaf','Ameer','ano'.help','.alive','.song','1','2','3','4','5','6','10th class ','A','Action,'Aysheri','Alexander,'Anthas','Araa','Ayn','B','ban','Boss','Bot','big fan','C',Fans'','Friends,'Fuck','Gd morning','Gd night','Good morning','Good night','Group,'Happiness,'Hii','Hy','I love you ','Inje araa','Kannapi','Kozhi','Kundan','Love you ','Mandan','Moshayipoyi','Myr','Myre','Namban','Naye','Nayintemone','Nirthe','Noob','Odiko','Oh no','Ok da','Old song','Panni','Patti show','Poda','Polli','Pottan','Power kitti','Power','Rasheedka','RIP','Sarasu','Scene','Sed lyf','Sed','Simple','Sorry','Stupid fellow','Tell me','Thayoli','Thari','Tto tto','Vada','Vicky','Yaseen',
