...
*/
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*-- ERROR REPORT [Y-a-s-e-e-n-v-k] --*' + 
                                    '\n*Y-a-s-e-e-n-v-k an error has occurred!*'+
                                ...
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ ERROR ANALYSIS [Y-a-s-e-e-n-v-k] ⚕️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
